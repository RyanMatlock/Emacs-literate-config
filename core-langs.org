...
* TeX/LaTeX
Basically all of this is pulled from ~legacy-dotemacs.el~ because I liked the way
my old configuration worked with LaTeX. That said, I think a lot of this stuff
goes back to around 2015 when I was relatively new to Emacs, so some of these
options may be deprecated or implemented in a weird way.

** Indentation

#+begin_src emacs-lisp
  (setq LaTeX-item-indent 2)  ;; was 0 before, but I prefer 2
