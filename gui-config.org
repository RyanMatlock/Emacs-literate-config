...
#+begin_quote
Aside: I think I've been mixing up ==verbatim== and =~code~= this whole time
:facepalm:; see [[https://orgmode.org/manual/Emphasis-and-Monospace.html][Emphasis and Monospace | Org Mode Manual]].
#+end_quote
